...
NUMBER=613
NAME=soma_s
SOURCES= mpi_timing.c allocator.c ana.c autotuner.c bond.c cmdline.c device.c \
	 generate_positions.c independent_sets.c init.c io.c mc.c mesh.c \
	 monomer.c mpiroutines.c phase.c polymer.c rng.c soma.c soma_config.c \
	 soma_util.c test.c specmpitime/specmpitime.c
EXEBASE=soma
NEED_MATH=yes
USE_SPACK=
BENCHLANG=C
...
COPTIMIZE        = -Ofast -march=native -lm -g
CXX              = mpicxx
...
log_line_width   = 0
log_timestamp    = 0
logname          = /home/jumeike/scratch.cmsc714/final-project/result/hpc2021.078.log
lognum           = 078
mail_reports     = all
mailcompress     = 0
mailmethod       = smtp
...
path             = /home/jumeike/scratch.cmsc714/final-project/benchspec/HPC/613.soma_s
plain_train      = 0
platform         = 
pmodel           = MPI
power            = 0
...
run              = all
rundir           = run
runhpc           = /home/jumeike/scratch.cmsc714/final-project/bin/harness/runhpc --fake --loose --size test --tune base --config Project-try1 --ranks 4 613
runmode          = speed
safe_eval        = 1
save_build_files = 
...
srcalt           = 
srcdir           = src
srcsource        = /home/jumeike/scratch.cmsc714/final-project/benchspec/HPC/613.soma_s/src
stagger          = 10
...
voltage_range    = 
worklist         = list
OUTPUT_RMFILES   = stateR42time10Npoly32000.txt
