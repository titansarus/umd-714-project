...
NUMBER=621
NAME=miniswp_s
SOURCES= mpi_timing.c 1_base/arguments.c 1_base/env.c 1_base/env_assert.c \
	 1_base/env_cuda.c 1_base/env_mpi.c 1_base/pointer.c \
	 2_sweeper_base/array_operations.c 2_sweeper_base/dimensions.c \
	 3_sweeper/faces_kba.c 3_sweeper/quantities.c \
	 3_sweeper/stepscheduler_kba.c 3_sweeper/sweeper.c \
	 3_sweeper/sweeper_kernels.c 4_driver/runner.c 4_driver/sweep.c \
...
COPTIMIZE        = -Ofast -march=native -lm -O3 -g
CXX              = mpicxx
...
log_line_width   = 0
log_timestamp    = 0
logname          = /home/jumeike/scratch.cmsc714/final-project/result/hpc2021.079.log
lognum           = 079
mail_reports     = all
mailcompress     = 0
mailmethod       = smtp
...
path             = /home/jumeike/scratch.cmsc714/final-project/benchspec/HPC/621.miniswp_s
plain_train      = 0
platform         = 
pmodel           = MPI
power            = 0
...
run              = all
rundir           = run
runhpc           = /home/jumeike/scratch.cmsc714/final-project/bin/harness/runhpc --fake --tune base --config Project-try1 --ranks 256 621
runmode          = speed
safe_eval        = 1
save_build_files = 
...
srcalt           = 
srcdir           = src
srcsource        = /home/jumeike/scratch.cmsc714/final-project/benchspec/HPC/621.miniswp_s/src
stagger          = 10
