...
#pragma acc enter data create(buf_xz[:size_facexz_per_octant],buf_yz[:size_faceyz_per_octant])
#endif  
...
#ifdef SPEC_ACCEL_AWARE_MPI
#pragma acc host_data use_device(face_per_octant)
#endif                
                {
            ...
            else
            {
              if( do_send )
              {
                const int proc_other
                                 = Env_proc( env, proc_x+inc_x, proc_y+inc_y );
#ifdef SPEC_ACCEL_AWARE_MPI                
#pragma acc host_data use_device(face_per_octant,buf)
#endif                
                {
  ...
  /*---Deallocations---*/
#ifdef SPEC_ACCEL_AWARE_MPI  
#pragma acc exit data delete(buf_xz[:size_facexz_per_octant],buf_yz[:size_faceyz_per_octant])
#endif  
  free_host_P( buf_xz );
  free_host_P( buf_yz );
}
