...
/*===========================================================================*/
/* Read an argument of type int, remove from list---*/

int Arguments_read_int_( Arguments*  args,
                            const char* arg_name );
/*===========================================================================*/
...
/*===========================================================================*/
/* Read an argument of type int, if not present then set to a default---*/

int Arguments_read_int_or_default( Arguments*  args,
                                      const char* arg_name,
                                      int         default_value );
