...
NUMBER=605
NAME=lbm_s
SOURCES= lbm.c main.c mpi_timing.c specrand/specrand.c specmpitime/specmpitime.c
EXEBASE=lbm
NEED_MATH=yes
USE_SPACK=
BENCHLANG=C
...
log_line_width   = 0
log_timestamp    = 0
logname          = /home/jumeike/scratch.cmsc714/final-project/result/hpc2021.076.log
lognum           = 076
mail_reports     = all
mailcompress     = 0
mailmethod       = smtp
...
path             = /home/jumeike/scratch.cmsc714/final-project/benchspec/HPC/605.lbm_s
plain_train      = 0
platform         = 
pmodel           = MPI
power            = 0
...
run              = all
rundir           = run
runhpc           = /home/jumeike/scratch.cmsc714/final-project/bin/harness/runhpc --fake --tune base --config Project-try1 --ranks 256 605
runmode          = speed
safe_eval        = 1
save_build_files = 
...
srcalt           = 
srcdir           = src
srcsource        = /home/jumeike/scratch.cmsc714/final-project/benchspec/HPC/605.lbm_s/src
stagger          = 10
