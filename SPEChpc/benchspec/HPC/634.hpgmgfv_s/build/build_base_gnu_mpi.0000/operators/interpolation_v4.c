...
#pragma omp target data use_device_ptr(recv_buf_d)
  ...
  if(level_c->interpolation.num_blocks[0]>0){
    _timeStart = getTime();
    /* CD: The upstream CUDA code has if(level_c->use_offload)
       https://bitbucket.org/nsakharnykh/hpgmg-cuda/src/5ad473d84dd5db55e0a0848a8bb242c106430143/finite-volume/source/operators/interpolation_v4.c#lines-300
       I think this is a bug so changed it to if(level_f->use_offload) */
...
# endif
      ...
      device_interpolation_v4(level_f,id_f,0.0,level_c,id_c,&level_c->interpolation,0);
...
# endif
      ...
      device_interpolation_v4(level_f,id_f,prescale_f,level_c,id_c,&level_c->interpolation,1);
    }
    else {
