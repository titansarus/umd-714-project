...
#include <string.h>
#include <math.h>
#if defined(SPEC_CUDA) || defined(SPEC_CUDA_API) || defined(USE_NVTX)
/* This is the C API. The C++ API is <cuda_runtime.h> */
...
typedef struct {
  ...
  double    * __restrict__     vectors_base_1;  // First valid element of vectors_base.
#endif
  ...
  // GPU-related info
  int use_offload;				// run operators on this level on GPU
...
void build_box_device(level_type *level,int);
...
void build_box_device_openmp(level_type *level,int);
