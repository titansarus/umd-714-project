...
NUMBER=618
NAME=tealeaf_s
SOURCES= 2d/chunk.c 2d/comms.c 2d/diffuse.c 2d/initialise.c 2d/main.c \
	 2d/parse_config.c 2d/profiler.c 2d/settings.c 2d/shared.c \
	 2d/drivers/cg_driver.c 2d/drivers/cheby_driver.c \
	 2d/drivers/eigenvalue_driver.c 2d/drivers/field_summary_driver.c \
	 2d/drivers/halo_update_driver.c 2d/drivers/jacobi_driver.c \
	 2d/drivers/kernel_initialise_driver.c 2d/drivers/ppcg_driver.c \
	 2d/drivers/remote_halo_driver.c 2d/drivers/set_chunk_data_driver.c \
	 2d/drivers/set_chunk_state_driver.c 2d/drivers/solve_finished_driver.c \
	 2d/drivers/store_energy_driver.c 2d/c_kernels/cg.c 2d/c_kernels/cheby.c \
	 2d/c_kernels/field_summary.c 2d/c_kernels/jacobi.c \
	 2d/c_kernels/kernel_initialise.c 2d/c_kernels/kernel_interface.c \
	 2d/c_kernels/local_halos.c 2d/c_kernels/pack_halos.c 2d/c_kernels/ppcg.c \
	 2d/c_kernels/set_chunk_data.c 2d/c_kernels/set_chunk_state.c \
	 2d/c_kernels/solver_methods.c 2d/c_kernels/store_energy.c \
	 2d/c_kernels/diffuse_overload.c specmpitime/specmpitime.c
EXEBASE=tealeaf
NEED_MATH=
USE_SPACK=
BENCHLANG=C
...
commandexe       = tealeaf_base.gnu_mpi
...
path             = /home/jumeike/scratch.cmsc714/final-project/benchspec/HPC/618.tealeaf_s
plain_train      = 0
platform         = 
pmodel           = MPI
power            = 0
...
srcalt           = 
srcdir           = src
srcsource        = /home/jumeike/scratch.cmsc714/final-project/benchspec/HPC/618.tealeaf_s/src
stagger          = 10
