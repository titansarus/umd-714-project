...
#define H5CONFIG_F_IKIND INTEGER, DIMENSION(1:num_ikinds) :: ikind = (/1,2,4,8/)

/* Define number of valid Fortran INTEGER KINDs */
#define H5CONFIG_F_NUM_IKIND INTEGER, PARAMETER :: num_ikinds = 4

/* Define number of valid Fortran REAL KINDs */
#define H5CONFIG_F_NUM_RKIND INTEGER, PARAMETER :: num_rkinds = 2

/* Define valid Fortran REAL KINDs */
#define H5CONFIG_F_RKIND INTEGER, DIMENSION(1:num_rkinds) :: rkind = (/4,8/)

/* Define valid Fortran REAL KINDs Sizeof */
#define H5CONFIG_F_RKIND_SIZEOF INTEGER, DIMENSION(1:num_rkinds) :: rkind_sizeof = (/4,8/)
...
#define HAVE_Fortran_INTEGER_SIZEOF_16 0
...
#define PAC_FC_MAX_REAL_PRECISION 15
