...
!$OMP TARGET DATA MAP(tofrom:vel1,volume,mass_flux_x,mass_flux_y,vol_flux_x,vol_flux_y,density1,celldx,celldy,mom_flux,node_flux,node_mass_post,node_mass_pre,post_vol,pre_vol)
#endif
...
#endif 
#ifdef SPEC_OPENMP_TARGET
!$OMP TARGET TEAMS DISTRIBUTE PARALLEL DO COLLAPSE(2) PRIVATE(upwind,downwind,donor,dif,sigma,width,limiter,vdiffuw,vdiffdw,auw,adw,wind,advec_vel_s)
#endif
#ifdef SPEC_OPENACC
!$ACC LOOP INDEPENDENT
#endif 
...
#ifdef SPEC_OPENMP_TARGET
!$OMP TARGET TEAMS DISTRIBUTE PARALLEL DO COLLAPSE(2) &
!$OMP  PRIVATE(upwind,donor,downwind,dif,sigma,width,limiter,vdiffuw,vdiffdw,auw,adw,wind,advec_vel_s)
#endif
#ifdef SPEC_OPENACC
!$ACC LOOP INDEPENDENT
#endif 
