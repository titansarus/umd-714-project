...
!$OMP TARGET DATA   &
!$OMP map(to:density0, energy0, pressure, viscosity, soundspeed, density1, energy1, xvel0, yvel0, xvel1, yvel1, vol_flux_x, mass_flux_x, vol_flux_y, mass_flux_y)    &
!$OMP map(to:left_density0, left_energy0, left_pressure, left_viscosity, left_soundspeed, left_density1, left_energy1, left_xvel0, left_yvel0, left_xvel1, left_yvel1, left_vol_flux_x, left_mass_flux_x, left_vol_flux_y, left_mass_flux_y)
#endif
...
!$OMP TARGET DATA   &
!$OMP  map(to:density0, energy0, pressure, viscosity, soundspeed, density1, energy1, xvel0, yvel0, xvel1, yvel1, vol_flux_x, mass_flux_x, vol_flux_y, mass_flux_y)    &
!$OMP  map(to:right_density0, right_energy0, right_pressure, right_viscosity, right_soundspeed, right_density1, right_energy1, right_xvel0, right_yvel0, right_xvel1, right_yvel1, right_vol_flux_x, right_mass_flux_x, right_vol_flux_y, right_mass_flux_y)
#endif
...
!$OMP TARGET DATA   &
!$OMP  MAP(to:density0, energy0, pressure, viscosity, soundspeed, density1, energy1, xvel0, yvel0, xvel1, yvel1, vol_flux_x, mass_flux_x, vol_flux_y, mass_flux_y)    &
!$OMP  MAP(to:top_density0, top_energy0, top_pressure, top_viscosity, top_soundspeed, top_density1, top_energy1, top_xvel0, top_yvel0, top_xvel1, top_yvel1, top_vol_flux_x, top_mass_flux_x, top_vol_flux_y, top_mass_flux_y)
#endif
...
!$OMP TARGET DATA   &
!$OMP MAP(to:density0, energy0, pressure, viscosity, soundspeed, density1, energy1, xvel0, yvel0, xvel1, yvel1, vol_flux_x, mass_flux_x, vol_flux_y, mass_flux_y)    &
!$OMP MAP(to:bottom_density0, bottom_energy0, bottom_pressure, bottom_viscosity, bottom_soundspeed, bottom_density1, bottom_energy1 ) &
!$OMP MAP(to:bottom_xvel0, bottom_yvel0, bottom_xvel1, bottom_yvel1, bottom_vol_flux_x, bottom_mass_flux_x, bottom_vol_flux_y, bottom_mass_flux_y)
#endif
