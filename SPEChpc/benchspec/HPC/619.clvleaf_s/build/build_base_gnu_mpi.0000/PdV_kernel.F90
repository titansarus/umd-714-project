...
!$OMP density0,energy0,pressure,viscosity,volume,xarea, &
!$OMP xvel0,yarea,yvel0, &
...
!$OMP  PRIVATE(right_flux,left_flux,top_flux,bottom_flux,total_flux,min_cell_volume, &
!$OMP          energy_change,recip_volume,volume_change_s)
#endif 
#ifdef SPEC_OPENACC
!$ACC KERNELS
