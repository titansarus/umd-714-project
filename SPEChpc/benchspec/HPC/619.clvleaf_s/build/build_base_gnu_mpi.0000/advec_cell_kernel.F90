...
!$OMP density1,energy1, &
!$OMP vol_flux_x,vol_flux_y,volume,mass_flux_x,mass_flux_y,vertexdx,vertexdy, &
!$OMP pre_vol,post_vol,ener_flux)
#endif
...
#ifdef SPEC_OPENMP_TARGET
!$OMP TARGET TEAMS DISTRIBUTE PARALLEL DO COLLAPSE(2) &
!$OMP  PRIVATE(upwind,donor,downwind,dif,sigmat,sigma3,sigma4,sigmav,sigma,sigmam, diffuw,diffdw,limiter,wind)
#endif
#ifdef SPEC_OPENACC
!$ACC LOOP INDEPENDENT
#endif 
...
#ifdef SPEC_OPENMP_TARGET
!$OMP TARGET TEAMS DISTRIBUTE PARALLEL DO COLLAPSE(2) &
!$OMP PRIVATE(pre_mass_s,post_mass_s,post_ener_s,advec_vol_s)
#endif
      DO k=y_min,y_max
#ifdef SPEC_OPENACC
